  ...
  <div class="todo ">
    <div class="w-full h-screen dark:bg-black">
      ...
      <div class="flex justify-between mx-4 relative top-10 sm:top-12 sm:justify-around sm:mx-4 md:mx-44 ">
        ...
        <div class="w-5 cursor-pointer "><img @click="toggleDark()" src="@/assets/images/icon-moon.svg" alt="" class="w-7"></div>

      </div>
      <div>
        <div class="relative flex flex-col justify-center items-center top-20 drop-shadow-2xl">

          <form class="flex  sm:w-96   mb-5">
          ...
          <!-- task list -->
          <div v-for=" (task, index) in tasks" class="  cursor-pointer flex bg-white w-80 sm:w-96 mx-3 py-2 justify-between text-left
         border-b-cyan-900 rounded-l-sm border-bottom font-normal dark:bg-blue-900 dark:text-white"
          ...
          <div
            ...
            <div>
              <span class=" cursor-pointer" @click="ALL()">All</span><span class="mx-2 cursor-pointer" @click="ActiveTask()">Active</span><span class="cursor-pointer"
